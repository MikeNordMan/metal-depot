'''Место для хранения Layout Реализация'''
...
openStrSale = 0  # Колличество открытых строк
...
def new_Sale ():
    ...
    heder = [
        ...
        [sg.Text('Дата реализации:', pad=(5, 5)), sg.InputText(key='data', pad=(67, 0), size=(15, 1))],
        [sg.Text('Покупатель:', pad=(5, 5)), sg.InputText(key='post', pad=(98, 0), size=(15, 1))],
    ...
    mol = [[[sg.InputCombo(names, size=(20, 1), key='mar' + str(i + 1), pad=(0, 1)),
             ...
             sg.Text(background_color='#639A67', key='res' + str(i + 1), size=(10, 1), pad=(10, 1), enable_events=True,
...
def buttonPrint():
    print('Проверка кнопи из Функции в Реализации')
